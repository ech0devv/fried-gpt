...
class Preferences private constructor(private var preferences: SharedPreferences, private var gp: SharedPreferences, private var chatId: String) {
    ...
    * */
    ...
    fun getNotSilence() : Boolean {
        return getBoolean("always_speak_mode", true)
    }
    ...
    fun getFunctionCalling() : Boolean {
        return getBoolean("function_calling", true)
    }
    ...
    fun getSystemMessage() : String {
        return getString("system_message", "You're a helpful voice assistant. Keep responses short and sweet, as you are being used in a live voice environment. Don't be afraid to act human, things like exclamatory words are great.")
    }
    ...
    fun getAssistantName() : String {
        return getString("assistant_name", "FriedGPT")
    }
