...
package dev.ech0.friedgpt.ui.adapters
...
import dev.ech0.friedgpt.ui.activities.ImageBrowserActivity
import dev.ech0.friedgpt.ui.fragments.dialogs.EditMessageDialogFragment
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (dataArray[position]["message"].toString().contains("data:image")) {
            ...
            if (dataArray[position]["isBot"] == true) {
                ...
                val markwon: Markwon = Markwon.builder(mContext).usePlugin(LinkifyPlugin.create()).usePlugin(object : AbstractMarkwonPlugin(){
